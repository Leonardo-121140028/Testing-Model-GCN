...
DATASET_PATH = os.path.join(os.path.join(os.getcwd(), 'test'), 'extracted_frames')
SKELETON_SAVE_PATH = os.path.join(os.path.join(os.getcwd(), 'test'), 'data-skeleton')
SKELETON_PREVIEW = os.path.join(os.path.join(os.getcwd(), 'test'), 'skeleton-preview')
